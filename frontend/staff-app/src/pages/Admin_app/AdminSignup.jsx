...
import '../../styles/Admin_app/signup.css';

function AuthPage() {
  const navigate = useNavigate();
  const [isLogin, setIsLogin] = useState(true);
  const { loginAdminUser, registerStaffUser } = useContext(AuthContext);
      ...
      <div className="form-card">
        {isLogin ? (
          <form onSubmit={handleSubmitLogin}>
            <h2>Mount Sunset Group Of Schools</h2>
            <a className="navbar-brand" href="#">
              <img className="image-card" src="https://i.imgur.com/juL1aAc.png" style={{ width: '50%', position: 'center', borderRadius: 'rem' }} />
            </a>
            <div className="form-input">
              <div><label htmlFor="form2Example17">Username</label></div>
              <input type="text" id="form2Example17" className="form-input" name='username' placeholder="Username"/>
          ...
          <form onSubmit={handleSubmitRegister}>
            ...
            <div className="form-input">
              ...
              <input type="text" id="firstNameInput" name="first_name" placeholder="First Name" 
            ...
            <div className="form-input">
              ...
              <input type="text" id="lastNameInput" name="last_name" placeholder="Last Name"
