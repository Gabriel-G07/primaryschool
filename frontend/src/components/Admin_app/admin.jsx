...
import AdminInfoHTML from '../../views/Admin_app/Admin/AdminInformationView';
import AdminDashboardHTML from '../../views/Admin_app/Admin/AdminDashboardView';
import AdminStaffHTML from '../../views/Admin_app/Admin/AdminStaffView';
import AdminFeesHTML from '../../views/Admin_app/Admin/AdminFeesView';
import AdminNoticesHTML from '../../views/Admin_app/Admin/AdminNoticesView';
import AdminResultsHTML from '../../views/Admin_app/Admin/AdminResultsView';
import AdminStudentsHTML from '../../views/Admin_app/Admin/AdminStudentsView'; 
import AdminApplicationsHTML from '../../views/Admin_app/Admin/AdminApplicationsView';
import AdminTimeTablesHTML from '../../views/Admin_app/Admin/AdminTimeTablesView';
import AdminSettingsHTML from '../../views/Admin_app/Admin/AdminSettingsView'; 
